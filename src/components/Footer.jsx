...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-base-300 to-base-200 border-t border-base-300/50">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-base-content/70 leading-relaxed">
              ...
              We provide quality care with dignity, respect, and genuine compassion.
            </p>
          ...
          <div className="space-y-6">
            ...
            {/* Certifications */}
            <div className="space-y-3">
              <h5 className="font-semibold text-base-content">Certifications</h5>
        ...
        <Container className="px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              ...
              <Link href="/cookies" className="text-base-content/70 hover:text-primary transition-colors">
                Cookie Policy
              </Link>
              <Link href="/sitemap" className="text-base-content/70 hover:text-primary transition-colors">
                Sitemap
              </Link>
            </div>
